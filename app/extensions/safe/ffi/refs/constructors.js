...
export const constructAppExchangeInfo = appInfo => new types.AppExchangeInfo( {
    id     : appInfo.id,
    scope  : appInfo.scope,
    name   : appInfo.name,
...
const constructPermissionSet = perms => new types.PermissionSet( {
    read               : perms.read,
    insert             : perms.insert,
    update             : perms.update,
    delete             : perms.delete,
...
export const constructContainerPermission = contPerm => new types.ContainerPermissions( {
...
export const constructAuthReq = authReq => new types.AuthReq( {
...
export const constructContainerReq = contReq => new types.ContainersReq( {
...
const constructShareMData = mdata => new types.ShareMData( {
...
export const constructSharedMdataReq = sharedMdataReq => new types.ShareMDataReq( {
